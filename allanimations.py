...
@champu_cmd(pattern=r"monster")
async def bluedevilmonster(monster):
    await eor(monster, A)

@champu_cmd(pattern=r"pig")
async def bluedevilpig(pig):
    await eor(pig, B)

@champu_cmd(pattern=r"killer")
async def bluedevilkiller(killer):
    await eor(killer, C)

@champu_cmd(pattern=r"gun")
async def bluedevilgun(gun):
    await eor(gun, D)

@champu_cmd(pattern=r"dog")
async def bluedevildog(dog):
    await eor(dog, E)    

@champu_cmd(pattern=r"hello")
async def bluedevilhello(hello):
    await eor(hello, F)

@champu_cmd(pattern=r"hmf")
async def bluedevilhmf(hmf):
    await eor(hmf, G)

@champu_cmd(pattern=r"couple")
async def bluedevilcouple(couple):
    await eor(couple, H)

@champu_cmd(pattern=r"sup$")
async def bluedevilsupreme(supreme):
    await eor(supreme, l)

@champu_cmd(pattern=r"india")
async def bluedevilindia(india):
    await eor(india, J)

@champu_cmd(pattern=r"wc")
async def bluedevilwelcome(welcome):
    await eor(welcome, K)

@champu_cmd(pattern=r"snk")
async def bluedevilsnake(snake):
    await eor(snake, L) 

@champu_cmd(pattern=r"cat")
async def bluedevilded(cat):
    await eor(cat, M)

@champu_cmd(pattern=r"bye")
async def bluedevilbye(e):
    await eor(e, N)

@champu_cmd(pattern=r"shitos")
async def bluedevilshitos(e):
    await eor(e, O)

@champu_cmd(pattern=r"dislike")
async def bluedevildislike(e):
    await eor(e, P)

@champu_cmd(pattern="stupid$")
async def _(ult):
    ult = await eor(ult, "`...`")
...
async def _(ult):
    ...
    animation_chars = [
        ...
        "⬜⬜⬛⬜⬜\n⬜⬛⬜⬜⬜\n🔴⬜⬜⬜⬜",
        "🔴⬛⬛⬜⬜\n⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜",
        "⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜\n⬜  [CHAMPU IS BEST](https://github.com/TheChampu) ⬜\n⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜",
    ]
...
@champu_cmd(pattern="solarsystem")
async def _(ult):
    animation_interval = 0.1
