...
from . import champu_cmd, get_string, HNDLR, async_searcher


@champu_cmd(pattern="joke$")
async def _(ult):
    await ult.eor(get_joke())


@champu_cmd(pattern="url ?(.*)")
async def _(event):
